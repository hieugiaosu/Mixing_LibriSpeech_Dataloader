...
class LibriSpeechMixingLoader:
    ...
    def __next__(self):
        ...
        data = [self.__getGroupData(self.windowStart+i*self.sampleRate*(self.audioLength-1)) for i in range(self.batch) if not self.reachend]
        o = {}
        ...
        self.windowStart=self.windowStart+self.batch*self.sampleRate*(self.audioLength-1)
